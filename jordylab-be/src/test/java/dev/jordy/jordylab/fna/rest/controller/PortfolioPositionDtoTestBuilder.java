...
class PortfolioPositionDtoTestBuilder {
    ...
    public static final UUID DEFAULT_ID = UUID.fromString("66666666-0000-0000-0000-000000000006");
    ...
    public static PortfolioPositionDto aDefaultPortfolioPositionDto() {
